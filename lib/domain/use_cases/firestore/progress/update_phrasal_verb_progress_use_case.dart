...
class UpdatePhrasalVerbProgressUseCase
    extends FutureUseCase<LectureProcess, void> {
  @override
  Future<void> run(LectureProcess input) {
    return injector.get<FirestoreRepository>().updatePhrasalVerbProgress(input);
  }
}
