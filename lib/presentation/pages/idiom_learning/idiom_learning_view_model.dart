...
class IdiomLearningViewModel extends StateNotifier<IdiomLearningState> {
  ...
  Future<void> tempDisableNextButton() async {
    state = state.copyWith(nextButtonState: ButtonState.disabled);
    Future.delayed(const Duration(seconds: 5), () {
      state = state.copyWith(nextButtonState: ButtonState.normal);
    });
  }
}
